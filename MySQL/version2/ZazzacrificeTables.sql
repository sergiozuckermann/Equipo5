...
CREATE TABLE events(
events_id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT UNIQUE,
...
scene_id TINYINT UNSIGNED NOT NULL,
...
FOREIGN KEY (consumable_id) REFERENCES consumable(consumable_id) ON UPDATE CASCADE
...
created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
FOREIGN KEY (weapon_id) REFERENCES weapons(weapon_id) ON UPDATE CASCADE,
FOREIGN KEY (player_id) REFERENCES players(player_id) ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
player_id int unsigned not null,
created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
FOREIGN KEY (element_id) REFERENCES elements(element_id)ON UPDATE CASCADE,
FOREIGN KEY (player_id) REFERENCES players(player_id) ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
