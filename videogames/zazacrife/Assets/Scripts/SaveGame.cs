...
public class Game{
    ...
    public int place;
    //BATTLE STATS
    public string damagemade;
    public string damagereceived;
    public string coinsreceived;
    public string misses;
    public string crits;
    public string melees;
    public string iceuses;
    public string fireuses;
    public string thunderuses;
...
public class SaveGame : MonoBehaviour
{
    ...
    public void SaveData()
    {
        ...
        game.damagemade=PlayerPrefs.GetString("Damagemade");
        game.damagereceived=PlayerPrefs.GetString("Damagereceived");
        game.coinsreceived=PlayerPrefs.GetString("Coinsmade");
        game.misses=PlayerPrefs.GetString("Misses");
        game.crits=PlayerPrefs.GetString("Crits");
        game.melees=PlayerPrefs.GetString("Melee");
        game.iceuses=PlayerPrefs.GetString("Ice");
        game.fireuses=PlayerPrefs.GetString("Fire");
        game.thunderuses=PlayerPrefs.GetString("Lightning");
